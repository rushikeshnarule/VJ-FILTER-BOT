...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001989082874')
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Movie_search_bot_group77') # Support Chat Link Without https:// or @
